<div class="container-fluid flex-column px-5 py-3 h-100 w-100">
    ...
    <div class="row px-5 d-flex align-items-center justify-content-center">
        ...
        <div class="col-3 d-flex flex-column align-items-center justify-content-center">
            <p class="w-50" id="weather-temperature">Temperature: {{ $temperature }} ℃</p>
            <p class="w-50" id="weather-humidity">Humidity: {{ $humidity }} %</p>
            <p class="w-50" id="weather-rain">Rain: {{ $rain }} mm</p>
        </div>
    </div>
</div>
